...
[Machine-language data structures](../../docs/ML-DATA-STRUCTURES.md) map every engine-owned workspace byte, BASIC array layout, serialized field, and embedded table. [Mermaid activity diagrams](../../docs/Diagrams/README.md) trace every semantic code label and name the exact structures each routine reads or modifies. The public-vector diagrams use the executable BASIC demonstrations as caller context.
